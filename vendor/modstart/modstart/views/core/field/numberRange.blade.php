<div class="line" data-field="{{$name}}" id="{{$id}}">
    ...
    <div class="field">
        <div id="{{$id}}Input">
            ...
            <div>
                <el-input type="number" style="width:5rem;" placeholder="最小值" v-model="value['min']"></el-input>
                -
                <el-input type="number" style="width:5rem;" placeholder="最大值" v-model="value['max']"></el-input>
            </div>
        </div>
        @if(!empty($help))
